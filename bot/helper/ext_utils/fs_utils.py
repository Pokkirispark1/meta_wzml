...
"""
    ...
    cmd = [bot_cache['pkgs'][2], '-hide_banner', '-ignore_unknown', 
           ...
           '-metadata:v:0', f'title={metadata}', # Original video metadata
           '-metadata:a', f'title={metadata}', # Original audio metadata
           '-metadata:s', f'title={metadata}', # Original subtitle metadata
